...
class AppAuthorizerMicrosoftDynamics365MicrosoftDynamics365AuthorizerGetAuthorizationUrlRequest(BaseModel):
    """
    AppAuthorizerMicrosoftDynamics365MicrosoftDynamics365AuthorizerGetAuthorizationUrlRequest
    """ # noqa: E501
    config: Optional[List[AppAuthorizerMicrosoftDynamics365MicrosoftDynamics365AuthorizerGetAuthorizationUrlRequestConfigInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": [AppAuthorizerMicrosoftDynamics365MicrosoftDynamics365AuthorizerGetAuthorizationUrlRequestConfigInner.from_dict(_item) for _item in obj["config"]] if obj.get("config") is not None else None
        })
        return _obj
