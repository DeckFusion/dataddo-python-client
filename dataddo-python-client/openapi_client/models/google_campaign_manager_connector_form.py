...
class GoogleCampaignManagerConnectorForm(BaseModel):
    """
    ...
    date_range_expression: StrictStr = Field(alias="dateRangeExpression")
    __properties: ClassVar[List[str]] = ["ensureDataTypes", "allowEmpty", "nullableFields", "connectorId", "templateId", "strategy", "storageStrategy", "label", "oAuthId", "dateRange", "profileId", "reportType", "dateRangeExpression"]
