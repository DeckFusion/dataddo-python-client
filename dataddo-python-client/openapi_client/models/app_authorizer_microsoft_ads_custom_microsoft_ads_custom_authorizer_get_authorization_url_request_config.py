...
class AppAuthorizerMicrosoftAdsCustomMicrosoftAdsCustomAuthorizerGetAuthorizationUrlRequestConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["clientId", "redirectUri", "tenantId", "developerToken"]
