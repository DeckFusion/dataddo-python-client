...
class AppAuthorizerPinterestCustomPinterestCustomAuthorizerGetAuthorizationUrlRequest(BaseModel):
    """
    AppAuthorizerPinterestCustomPinterestCustomAuthorizerGetAuthorizationUrlRequest
    """ # noqa: E501
    config: Optional[List[AppAuthorizerPinterestCustomPinterestCustomAuthorizerGetAuthorizationUrlRequestConfigInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": [AppAuthorizerPinterestCustomPinterestCustomAuthorizerGetAuthorizationUrlRequestConfigInner.from_dict(_item) for _item in obj["config"]] if obj.get("config") is not None else None,
            "state": obj.get("state"),
