...
class FacebookPostConnectorForm(BaseModel):
    """
    ...
    limit: StrictInt
    __properties: ClassVar[List[str]] = ["ensureDataTypes", "allowEmpty", "nullableFields", "connectorId", "templateId", "strategy", "storageStrategy", "label", "oAuthId", "pageId", "metric", "dataLabel", "limit"]
