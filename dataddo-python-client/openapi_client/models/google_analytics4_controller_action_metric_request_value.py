...
class GoogleAnalytics4ControllerActionMetricRequestValue(BaseModel):
    """
    GoogleAnalytics4ControllerActionMetricRequestValue
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["oAuthId", "propertyId"]
