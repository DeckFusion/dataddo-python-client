...
class AppAuthorizerIntercomIntercomAuthorizerGetAuthorizationUrlRequestConfig(BaseModel):
    """
    AppAuthorizerIntercomIntercomAuthorizerGetAuthorizationUrlRequestConfig
    """ # noqa: E501
    domain: StrictStr
