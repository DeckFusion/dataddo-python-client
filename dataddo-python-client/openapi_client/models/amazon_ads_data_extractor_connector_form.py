...
class AmazonAdsDataExtractorConnectorForm(BaseModel):
    """
    ...
    flow: StrictStr = Field(description="Dataddo Flow endpoint")
    token: StrictStr = Field(description="Dataddo token")
    __properties: ClassVar[List[str]] = ["ensureDataTypes", "allowEmpty", "nullableFields", "connectorId", "templateId", "strategy", "storageStrategy", "label", "flow", "token"]
