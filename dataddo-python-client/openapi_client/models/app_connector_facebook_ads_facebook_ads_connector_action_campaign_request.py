...
class AppConnectorFacebookAdsFacebookAdsConnectorActionCampaignRequest(BaseModel):
    """
    AppConnectorFacebookAdsFacebookAdsConnectorActionCampaignRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["oAuthId", "accountId"]
