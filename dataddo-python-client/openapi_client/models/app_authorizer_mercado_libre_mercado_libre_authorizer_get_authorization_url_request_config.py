...
class AppAuthorizerMercadoLibreMercadoLibreAuthorizerGetAuthorizationUrlRequestConfig(BaseModel):
    """
    AppAuthorizerMercadoLibreMercadoLibreAuthorizerGetAuthorizationUrlRequestConfig
    """ # noqa: E501
