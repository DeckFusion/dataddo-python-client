...
class AppAuthorizerHubspotCustomHubspotCustomAuthorizerGetAuthorizationUrlRequestConfig(BaseModel):
    """
    ...
    optional_scopes: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["clientId", "redirectUri", "scopes", "optional_scopes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "optional_scopes": obj.get("optional_scopes")
        })
        return _obj
