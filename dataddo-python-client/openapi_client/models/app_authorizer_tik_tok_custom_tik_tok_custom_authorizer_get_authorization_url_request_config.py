...
class AppAuthorizerTikTokCustomTikTokCustomAuthorizerGetAuthorizationUrlRequestConfig(BaseModel):
    """
    AppAuthorizerTikTokCustomTikTokCustomAuthorizerGetAuthorizationUrlRequestConfig
    """ # noqa: E501
