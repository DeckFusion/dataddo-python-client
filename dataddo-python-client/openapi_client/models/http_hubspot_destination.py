...
class HttpHubspotDestination(BaseModel):
    """
    ...
    api_object: Optional[StrictStr] = Field(default=None, alias="apiObject")
    api_object_custom_name: Optional[StrictStr] = Field(default=None, alias="apiObjectCustomName")
    __properties: ClassVar[List[str]] = ["id", "customer_id", "created_at", "updated_at", "lastUse", "label", "description", "status", "statusDetail", "o_auth_id", "apiObject", "apiObjectCustomName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "apiObjectCustomName": obj.get("apiObjectCustomName")
        })
        return _obj
