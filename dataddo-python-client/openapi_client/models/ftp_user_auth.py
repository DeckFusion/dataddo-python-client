...
class FtpUserAuth(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "customer_id", "created_at", "updated_at", "label", "objectId", "status", "status_detail", "service_type", "last_use", "identifier", "hash", "host", "username", "port", "timeout"]
