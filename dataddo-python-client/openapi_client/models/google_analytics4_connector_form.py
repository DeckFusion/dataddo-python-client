...
class GoogleAnalytics4ConnectorForm(BaseModel):
    """
    ...
    sub_property_id: Optional[StrictStr] = Field(default=None, alias="subPropertyId")
    property_ids: Optional[List[StrictStr]] = Field(default=None, alias="propertyIds")
    metric: List[StrictStr]
    dimension: List[StrictStr]
    limit: Optional[StrictInt] = 10000
    dimension_filter: Optional[StrictStr] = Field(default=None, alias="dimensionFilter")
    metric_filter: Optional[StrictStr] = Field(default=None, alias="metricFilter")
    __properties: ClassVar[List[str]] = ["ensureDataTypes", "allowEmpty", "nullableFields", "connectorId", "templateId", "strategy", "storageStrategy", "label", "oAuthId", "dateRange", "useDataddoHash", "accountId", "propertyId", "subPropertyId", "propertyIds", "metric", "dimension", "limit", "dimensionFilter", "metricFilter"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subPropertyId": obj.get("subPropertyId"),
            "propertyIds": obj.get("propertyIds"),
            "metric": obj.get("metric"),
            "dimension": obj.get("dimension"),
            "limit": obj.get("limit") if obj.get("limit") is not None else 10000,
            "dimensionFilter": obj.get("dimensionFilter"),
            "metricFilter": obj.get("metricFilter")
        })
        return _obj
