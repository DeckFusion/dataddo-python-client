...
class HttpZohoDestination(BaseModel):
    """
    HttpZohoDestination
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "customer_id", "created_at", "updated_at", "lastUse", "label", "description", "status", "statusDetail", "o_auth_id", "module"]
