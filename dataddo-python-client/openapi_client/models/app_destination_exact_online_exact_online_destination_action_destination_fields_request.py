...
class AppDestinationExactOnlineExactOnlineDestinationActionDestinationFieldsRequest(BaseModel):
    """
    AppDestinationExactOnlineExactOnlineDestinationActionDestinationFieldsRequest
    """ # noqa: E501
    destination_id: Optional[StrictStr] = Field(default=None, alias="destinationId")
    write_mode: Optional[StrictStr] = Field(default=None, alias="writeMode")
    __properties: ClassVar[List[str]] = ["destinationId", "writeMode"]
