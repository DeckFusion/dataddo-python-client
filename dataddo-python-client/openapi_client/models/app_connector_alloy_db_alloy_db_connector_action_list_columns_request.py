...
class AppConnectorAlloyDbAlloyDbConnectorActionListColumnsRequest(BaseModel):
    """
    AppConnectorAlloyDbAlloyDbConnectorActionListColumnsRequest
    """ # noqa: E501
    o_auth_id: Optional[StrictStr] = Field(default=None, alias="oAuthId")
    table: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["oAuthId", "table"]
