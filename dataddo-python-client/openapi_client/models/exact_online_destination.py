...
class ExactOnlineDestination(BaseModel):
    """
    ...
    division_id: Optional[StrictStr] = None
    endpoint: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "customer_id", "created_at", "updated_at", "lastUse", "label", "description", "status", "statusDetail", "o_auth_id", "division_id", "endpoint"]
