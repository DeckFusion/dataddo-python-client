...
class Api(BaseModel):
    ...
    customer_id: Optional[StrictStr] = Field(default=None, description="Customer identifier")
    app: Optional[StrictStr] = Field(default=None, description="Dashboard app type")
    last: Optional[Any] = Field(default=None, description="Last execution")
    __properties: ClassVar[List[str]] = ["id", "customer_id", "app", "last"]
