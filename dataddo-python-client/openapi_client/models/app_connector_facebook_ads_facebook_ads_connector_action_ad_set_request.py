...
class AppConnectorFacebookAdsFacebookAdsConnectorActionAdSetRequest(BaseModel):
    """
    AppConnectorFacebookAdsFacebookAdsConnectorActionAdSetRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["oAuthId", "accountId", "campaignId"]
