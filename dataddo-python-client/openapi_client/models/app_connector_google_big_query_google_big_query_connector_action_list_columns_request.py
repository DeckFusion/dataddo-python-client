...
class AppConnectorGoogleBigQueryGoogleBigQueryConnectorActionListColumnsRequest(BaseModel):
    """
    AppConnectorGoogleBigQueryGoogleBigQueryConnectorActionListColumnsRequest
    """ # noqa: E501
