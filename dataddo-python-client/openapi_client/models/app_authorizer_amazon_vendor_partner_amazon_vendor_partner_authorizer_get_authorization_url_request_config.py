...
class AppAuthorizerAmazonVendorPartnerAmazonVendorPartnerAuthorizerGetAuthorizationUrlRequestConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["region", "store_name"]
