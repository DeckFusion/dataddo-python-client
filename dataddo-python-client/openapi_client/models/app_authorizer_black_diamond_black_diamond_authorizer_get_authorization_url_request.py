...
class AppAuthorizerBlackDiamondBlackDiamondAuthorizerGetAuthorizationUrlRequest(BaseModel):
    """
    AppAuthorizerBlackDiamondBlackDiamondAuthorizerGetAuthorizationUrlRequest
    """ # noqa: E501
    config: Optional[AppAuthorizerBlackDiamondBlackDiamondAuthorizerGetAuthorizationUrlRequestConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": AppAuthorizerBlackDiamondBlackDiamondAuthorizerGetAuthorizationUrlRequestConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "state": obj.get("state"),
