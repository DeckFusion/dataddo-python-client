...
class AppAuthorizerGoogleSheetsGoogleSheetsAuthorizerOAuthRequestURLRequest(BaseModel):
    """
    AppAuthorizerGoogleSheetsGoogleSheetsAuthorizerOAuthRequestURLRequest
    """ # noqa: E501
