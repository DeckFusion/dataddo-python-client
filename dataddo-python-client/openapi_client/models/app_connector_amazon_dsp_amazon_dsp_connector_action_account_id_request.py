...
class AppConnectorAmazonDspAmazonDspConnectorActionAccountIdRequest(BaseModel):
    """
    AppConnectorAmazonDspAmazonDspConnectorActionAccountIdRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["oAuthId", "profileId"]
