...
class AppAuthorizerAmazonSellingPartnerCustomAmazonSellingPartnerCustomAuthorizerGetAuthorizationUrlRequest(BaseModel):
    """
    AppAuthorizerAmazonSellingPartnerCustomAmazonSellingPartnerCustomAuthorizerGetAuthorizationUrlRequest
    """ # noqa: E501
    config: AppAuthorizerAmazonSellingPartnerCustomAmazonSellingPartnerCustomAuthorizerGetAuthorizationUrlRequestConfig
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": AppAuthorizerAmazonSellingPartnerCustomAmazonSellingPartnerCustomAuthorizerGetAuthorizationUrlRequestConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "state": obj.get("state"),
