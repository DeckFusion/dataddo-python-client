...
class YoutubeVideoConnectorForm(BaseModel):
    """
    ...
    channel_id: StrictStr = Field(description="Your channel id", alias="channelId")
    playlist_id: StrictStr = Field(description="Your playlist id", alias="playlistId")
    attribute: List[StrictStr] = Field(description="YT attributes")
    __properties: ClassVar[List[str]] = ["ensureDataTypes", "allowEmpty", "nullableFields", "connectorId", "templateId", "strategy", "storageStrategy", "label", "oAuthId", "dateRange", "channelId", "playlistId", "attribute"]
