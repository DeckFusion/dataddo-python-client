...
class GoogleMysqlDtoAuthorizer(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["host", "port", "username", "database", "sshConfig", "ssl", "tls", "useSSH", "certificateId", "sshHost", "sshPort", "sshRemoteHost", "sshRemotePort", "sshUsername", "sshPassword", "password", "label"]
