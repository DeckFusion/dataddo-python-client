...
class SalesforceConnectorForm(BaseModel):
    """
    ...
    attribute: List[StrictStr] = Field(description="List of selected fields")
    __properties: ClassVar[List[str]] = ["ensureDataTypes", "allowEmpty", "nullableFields", "connectorId", "templateId", "strategy", "storageStrategy", "label", "oAuthId", "instance", "object", "apiVersion", "filter", "attribute"]
