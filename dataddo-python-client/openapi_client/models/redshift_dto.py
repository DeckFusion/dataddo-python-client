...
class RedshiftDto(BaseModel):
    ...
    storage_id: Optional[StrictStr] = Field(default=None, alias="storageId")
    __properties: ClassVar[List[str]] = ["connector_id", "template_id", "label", "storage_strategy", "allow_empty", "o_auth_id", "statement", "storageId"]
