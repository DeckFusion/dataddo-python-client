...
class FlowOperationJoinCondition(BaseModel):
    """
    FlowOperationJoinCondition
    """ # noqa: E501
    source_column: Optional[StrictStr] = None
    target_column: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["source_column", "target_column"]
