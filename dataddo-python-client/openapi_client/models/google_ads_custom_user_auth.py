...
class GoogleAdsCustomUserAuth(BaseModel):
    """
    ...
    developer_token: Optional[StrictStr] = Field(default=None, alias="developerToken")
    client_customer_id: Optional[StrictStr] = Field(default=None, alias="clientCustomerId")
    __properties: ClassVar[List[str]] = ["id", "customer_id", "created_at", "updated_at", "label", "objectId", "status", "status_detail", "service_type", "last_use", "identifier", "hash", "clientId", "clientSecret", "redirectUri", "developerToken", "clientCustomerId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "developerToken": obj.get("developerToken"),
            "clientCustomerId": obj.get("clientCustomerId")
        })
        return _obj
