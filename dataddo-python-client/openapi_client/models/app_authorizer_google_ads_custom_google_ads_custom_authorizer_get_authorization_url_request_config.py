...
class AppAuthorizerGoogleAdsCustomGoogleAdsCustomAuthorizerGetAuthorizationUrlRequestConfig(BaseModel):
    """
    ...
    developer_token: StrictStr = Field(alias="developerToken")
    redirect_uri: StrictStr = Field(alias="redirectUri")
    client_customer_id: StrictStr = Field(alias="clientCustomerId")
    scopes: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["clientId", "developerToken", "redirectUri", "clientCustomerId", "scopes"]
