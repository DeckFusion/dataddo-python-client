...
class FtpDtoAuthorizer(BaseModel):
    """
    FtpDtoAuthorizer
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["host", "username", "port", "timeout", "disableExplicitTLS", "dialTimeout", "shutTimeout", "disableEPSV", "disableUTF8", "disableMLSD", "MDTMWrite", "password", "label"]
