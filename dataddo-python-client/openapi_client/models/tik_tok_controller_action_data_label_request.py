...
class TikTokControllerActionDataLabelRequest(BaseModel):
    """
    TikTokControllerActionDataLabelRequest
    """ # noqa: E501
    report_type: Optional[StrictStr] = Field(default=None, alias="reportType")
    id_dimension: Optional[StrictStr] = Field(default=None, alias="idDimension")
    __properties: ClassVar[List[str]] = ["reportType", "idDimension"]
