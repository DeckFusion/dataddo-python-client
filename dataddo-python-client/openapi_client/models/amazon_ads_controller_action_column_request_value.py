...
class AmazonAdsControllerActionColumnRequestValue(BaseModel):
    """
    ...
    group_by: Optional[List[Any]] = Field(default=None, alias="groupBy")
    __properties: ClassVar[List[str]] = ["reportType", "timeUnit", "groupBy"]
