...
class SnapchatLookupConnectorForm(BaseModel):
    """
    ...
    level: StrictStr
    attribute: List[StrictStr] = Field(description="Snapchat attributes")
    __properties: ClassVar[List[str]] = ["ensureDataTypes", "allowEmpty", "nullableFields", "connectorId", "templateId", "strategy", "storageStrategy", "label", "oAuthId", "organizationId", "accountId", "level", "attribute"]
