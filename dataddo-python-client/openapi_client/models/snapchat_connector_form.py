...
class SnapchatConnectorForm(BaseModel):
    """
    ...
    organization_id: StrictStr = Field(description="Snapchat Organization identifier", alias="organizationId")
    account_id: StrictStr = Field(description="Snapchat Ad Account identifier", alias="accountId")
    metrics: List[StrictStr]
    labels: List[StrictStr]
    breakdown: StrictStr
    action_report_time: StrictStr
    swipe_up_attribution_window: StrictStr
    view_attribution_window: StrictStr
    __properties: ClassVar[List[str]] = ["ensureDataTypes", "allowEmpty", "nullableFields", "connectorId", "templateId", "strategy", "storageStrategy", "label", "oAuthId", "dateRange", "organizationId", "accountId", "metrics", "labels", "breakdown", "action_report_time", "swipe_up_attribution_window", "view_attribution_window"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "swipe_up_attribution_window": obj.get("swipe_up_attribution_window"),
