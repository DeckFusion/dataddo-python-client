...
class TikTokConnectorForm(BaseModel):
    """
    TikTokConnectorForm
    """ # noqa: E501
    ...
    advertiser_id: StrictStr = Field(description="TikTok advertiser ID", alias="advertiserId")
    metric: List[StrictStr]
    data_label: List[StrictStr] = Field(description="Data labels to be included in the result", alias="dataLabel")
    id_dimension: StrictStr = Field(description="ID dimension to be included in the result", alias="idDimension")
    time_dimension: StrictStr = Field(description="Time dimension to be included in the result", alias="timeDimension")
    audience_dimension: StrictStr = Field(description="Audience dimension to be included in the result", alias="audienceDimension")
    report_type: StrictStr = Field(alias="reportType")
    data_level: StrictStr = Field(alias="dataLevel")
    __properties: ClassVar[List[str]] = ["ensureDataTypes", "allowEmpty", "nullableFields", "connectorId", "templateId", "strategy", "storageStrategy", "label", "oAuthId", "dateRange", "advertiserId", "metric", "dataLabel", "idDimension", "timeDimension", "audienceDimension", "reportType", "dataLevel"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "idDimension": obj.get("idDimension"),
            "timeDimension": obj.get("timeDimension"),
            "audienceDimension": obj.get("audienceDimension"),
