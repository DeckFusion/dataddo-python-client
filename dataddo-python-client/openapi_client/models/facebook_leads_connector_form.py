...
class FacebookLeadsConnectorForm(BaseModel):
    """
    ...
    limit: StrictInt
    __properties: ClassVar[List[str]] = ["ensureDataTypes", "allowEmpty", "nullableFields", "connectorId", "templateId", "strategy", "storageStrategy", "label", "oAuthId", "dateRange", "pageId", "formId", "attribute", "limit"]
