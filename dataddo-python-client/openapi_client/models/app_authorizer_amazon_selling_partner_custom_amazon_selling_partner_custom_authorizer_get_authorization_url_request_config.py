...
class AppAuthorizerAmazonSellingPartnerCustomAmazonSellingPartnerCustomAuthorizerGetAuthorizationUrlRequestConfig(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["appId", "redirectUri", "scopes"]
