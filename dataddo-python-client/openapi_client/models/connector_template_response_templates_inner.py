...
class ConnectorTemplateResponseTemplatesInner(BaseModel):
    """
    ...
    category_id: Optional[List[Any]] = Field(default=None, alias="categoryId")
    attributes: Optional[List[Any]] = None
    __properties: ClassVar[List[str]] = ["name", "description", "type", "templateId", "categoryId", "attributes"]
