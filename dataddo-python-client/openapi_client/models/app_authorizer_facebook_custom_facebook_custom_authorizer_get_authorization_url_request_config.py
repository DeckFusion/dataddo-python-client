...
class AppAuthorizerFacebookCustomFacebookCustomAuthorizerGetAuthorizationUrlRequestConfig(BaseModel):
    """
    AppAuthorizerFacebookCustomFacebookCustomAuthorizerGetAuthorizationUrlRequestConfig
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["clientId", "redirectUri", "scopes"]
