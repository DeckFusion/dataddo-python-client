...
class AppAuthorizerIntercomIntercomAuthorizerGetAuthorizationUrlRequest(BaseModel):
    """
    AppAuthorizerIntercomIntercomAuthorizerGetAuthorizationUrlRequest
    """ # noqa: E501
    config: AppAuthorizerIntercomIntercomAuthorizerGetAuthorizationUrlRequestConfig
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": AppAuthorizerIntercomIntercomAuthorizerGetAuthorizationUrlRequestConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "state": obj.get("state"),
