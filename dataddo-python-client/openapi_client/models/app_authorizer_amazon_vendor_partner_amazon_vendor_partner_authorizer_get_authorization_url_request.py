...
class AppAuthorizerAmazonVendorPartnerAmazonVendorPartnerAuthorizerGetAuthorizationUrlRequest(BaseModel):
    """
    AppAuthorizerAmazonVendorPartnerAmazonVendorPartnerAuthorizerGetAuthorizationUrlRequest
    """ # noqa: E501
    config: Optional[AppAuthorizerAmazonVendorPartnerAmazonVendorPartnerAuthorizerGetAuthorizationUrlRequestConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": AppAuthorizerAmazonVendorPartnerAmazonVendorPartnerAuthorizerGetAuthorizationUrlRequestConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "state": obj.get("state"),
