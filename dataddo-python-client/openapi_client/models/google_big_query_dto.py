...
class GoogleBigQueryDto(BaseModel):
    """
    GoogleBigQueryDto
    """ # noqa: E501
    ...
    session_read: Optional[StrictBool] = Field(default=None, alias="sessionRead")
    columns: Optional[List[Any]] = None
    row_restriction: Optional[StrictStr] = Field(default=None, alias="rowRestriction")
    __properties: ClassVar[List[str]] = ["connector_id", "template_id", "label", "storage_strategy", "allow_empty", "request", "o_auth_id", "projectId", "datasetId", "tableId", "statement", "sessionRead", "columns", "rowRestriction"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sessionRead": obj.get("sessionRead"),
            "columns": obj.get("columns"),
            "rowRestriction": obj.get("rowRestriction")
        })
        return _obj
