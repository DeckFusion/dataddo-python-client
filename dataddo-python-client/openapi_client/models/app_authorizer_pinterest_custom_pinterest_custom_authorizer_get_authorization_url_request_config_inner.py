...
class AppAuthorizerPinterestCustomPinterestCustomAuthorizerGetAuthorizationUrlRequestConfigInner(BaseModel):
    """
    AppAuthorizerPinterestCustomPinterestCustomAuthorizerGetAuthorizationUrlRequestConfigInner
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["clientId", "redirectUri"]
