...
class AppConnectorAmazonDspAmazonDspConnectorActionMetricsRequest(BaseModel):
    """
    AppConnectorAmazonDspAmazonDspConnectorActionMetricsRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["oAuthId", "reportType"]
