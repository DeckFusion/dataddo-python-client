...
class HubspotConnectorForm(BaseModel):
    """
    ...
    attributes: Optional[List[StrictStr]] = Field(default=None, description="Final selections of the attributes to be included in the source")
    object: StrictStr
    var_property: List[StrictStr] = Field(alias="property")
    __properties: ClassVar[List[str]] = ["ensureDataTypes", "allowEmpty", "nullableFields", "connectorId", "templateId", "strategy", "storageStrategy", "label", "oAuthId", "url", "method", "headers", "body", "transformation", "emitter", "parameters", "attributes", "object", "property"]
