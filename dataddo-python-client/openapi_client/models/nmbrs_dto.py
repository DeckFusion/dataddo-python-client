...
class NmbrsDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["connector_id", "template_id", "label", "storage_strategy", "allow_empty", "request", "o_auth_id", "company", "dataset", "dateRange"]
