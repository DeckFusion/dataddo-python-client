...
class FlowPreviewRequest(BaseModel):
    ...
    FlowPreviewRequest
    """ # noqa: E501
    sources: Optional[List[StrictStr]] = Field(default=None, description="List of sources to be used")
    operations: Optional[List[OperationRequest]] = Field(default=None, description="List of DPI operations to be applied to sources defined above")
    __properties: ClassVar[List[str]] = ["sources", "operations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "operations": [OperationRequest.from_dict(_item) for _item in obj["operations"]] if obj.get("operations") is not None else None
        })
        return _obj
