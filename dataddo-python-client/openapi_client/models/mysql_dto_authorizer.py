...
class MysqlDtoAuthorizer(BaseModel):
    """
    MysqlDtoAuthorizer
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["host", "port", "username", "database", "sshConfig", "ssl", "tls", "extraParams", "useSSH", "certificateId", "sshHost", "sshPort", "sshRemoteHost", "sshRemotePort", "sshUsername", "sshPassword", "password", "label"]
