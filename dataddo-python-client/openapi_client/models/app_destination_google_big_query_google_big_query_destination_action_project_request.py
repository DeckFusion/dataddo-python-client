...
class AppDestinationGoogleBigQueryGoogleBigQueryDestinationActionProjectRequest(BaseModel):
    """
    AppDestinationGoogleBigQueryGoogleBigQueryDestinationActionProjectRequest
    """ # noqa: E501
