...
class AppAuthorizerGoogleAdsCustomGoogleAdsCustomAuthorizerGetAuthorizationUrlRequest(BaseModel):
    """
    AppAuthorizerGoogleAdsCustomGoogleAdsCustomAuthorizerGetAuthorizationUrlRequest
    """ # noqa: E501
    config: AppAuthorizerGoogleAdsCustomGoogleAdsCustomAuthorizerGetAuthorizationUrlRequestConfig
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": AppAuthorizerGoogleAdsCustomGoogleAdsCustomAuthorizerGetAuthorizationUrlRequestConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "state": obj.get("state"),
