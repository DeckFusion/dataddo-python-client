...
class AppDestinationGoogleBigQueryGoogleBigQueryDestinationActionDatasetRequest(BaseModel):
    """
    AppDestinationGoogleBigQueryGoogleBigQueryDestinationActionDatasetRequest
    """ # noqa: E501
