...
class TikTokControllerActionAudienceDimensionRequest(BaseModel):
    """
    TikTokControllerActionAudienceDimensionRequest
    """ # noqa: E501
    report_type: Optional[StrictStr] = Field(default=None, alias="reportType")
    data_level: Optional[StrictStr] = Field(default=None, alias="dataLevel")
    __properties: ClassVar[List[str]] = ["reportType", "dataLevel"]
