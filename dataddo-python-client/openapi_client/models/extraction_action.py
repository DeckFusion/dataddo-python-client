...
class ExtractionAction(BaseModel):
    ...
    storage: Optional[StrictStr] = Field(default=None, description="Use storageStrategy instead.")
    storage_strategy: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "status", "status_detail", "duration", "object_id", "object_type", "type", "customer_id", "last_execution", "next_execution", "error_count", "is_being_processed", "on_error_retry_timeout", "schedule", "storage", "storage_strategy"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "storage_strategy": obj.get("storage_strategy")
        })
        return _obj
