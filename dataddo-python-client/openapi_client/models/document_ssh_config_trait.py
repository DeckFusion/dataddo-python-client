...
class DocumentSshConfigTrait(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["password", "host", "port", "username", "certificateId", "remoteHost", "remotePort"]
