...
class AppAuthorizerHubspotCustomHubspotCustomAuthorizerGetAuthorizationUrlRequest(BaseModel):
    """
    AppAuthorizerHubspotCustomHubspotCustomAuthorizerGetAuthorizationUrlRequest
    """ # noqa: E501
    config: AppAuthorizerHubspotCustomHubspotCustomAuthorizerGetAuthorizationUrlRequestConfig
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "config": AppAuthorizerHubspotCustomHubspotCustomAuthorizerGetAuthorizationUrlRequestConfig.from_dict(obj["config"]) if obj.get("config") is not None else None,
            "state": obj.get("state"),
