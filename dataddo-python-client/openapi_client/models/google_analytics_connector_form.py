...
class GoogleAnalyticsConnectorForm(BaseModel):
    """
    ...
    dimension: Optional[List[StrictStr]] = None
    limit: Optional[StrictInt] = 1
    filter: Optional[StrictStr] = None
    sort: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["ensureDataTypes", "allowEmpty", "nullableFields", "connectorId", "templateId", "strategy", "storageStrategy", "label", "oAuthId", "dateRange", "useDataddoHash", "viewId", "dataLabel", "metric", "dimension", "limit", "filter", "sort"]
