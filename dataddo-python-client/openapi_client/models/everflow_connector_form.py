...
class EverflowConnectorForm(BaseModel):
    """
    ...
    time_column: Optional[StrictStr] = Field(default=None, alias="timeColumn")
    timezone_id: Optional[StrictStr] = Field(default=None, alias="timezoneId")
    currency: Optional[StrictStr] = None
    metric: List[StrictStr]
    __properties: ClassVar[List[str]] = ["ensureDataTypes", "allowEmpty", "nullableFields", "connectorId", "templateId", "strategy", "storageStrategy", "label", "oAuthId", "dateRange", "reportType", "column", "timeColumn", "timezoneId", "currency", "metric"]
