...
class FacebookAdsConnectorForm(BaseModel):
    """
    ...
    ad_set_id: Optional[StrictStr] = Field(default=None, alias="adSetId")
    time_breakup: StrictStr = Field(alias="timeBreakup")
    level: StrictStr
    metric: List[StrictStr]
    breakdown: Optional[List[StrictStr]] = None
    data_label: List[StrictStr] = Field(alias="dataLabel")
    __properties: ClassVar[List[str]] = ["ensureDataTypes", "allowEmpty", "nullableFields", "connectorId", "templateId", "strategy", "storageStrategy", "label", "oAuthId", "dateRange", "useDataddoHash", "accountId", "campaignId", "adSetId", "timeBreakup", "level", "metric", "breakdown", "dataLabel"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if ad_set_id (nullable) is None
        # and model_fields_set contains the field
        if self.ad_set_id is None and "ad_set_id" in self.model_fields_set:
            _dict['adSetId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "adSetId": obj.get("adSetId"),
            "timeBreakup": obj.get("timeBreakup") if obj.get("timeBreakup") is not None else 'all_days',
            "level": obj.get("level"),
