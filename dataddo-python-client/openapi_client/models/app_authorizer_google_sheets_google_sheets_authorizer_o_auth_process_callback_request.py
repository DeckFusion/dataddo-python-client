...
class AppAuthorizerGoogleSheetsGoogleSheetsAuthorizerOAuthProcessCallbackRequest(BaseModel):
    """
    AppAuthorizerGoogleSheetsGoogleSheetsAuthorizerOAuthProcessCallbackRequest
    """ # noqa: E501
    callback_url: Optional[StrictStr] = Field(default=None, alias="callbackUrl")
    config: Optional[List[AppAuthorizerGoogleSheetsGoogleSheetsAuthorizerOAuthProcessCallbackRequestConfigInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "config": [AppAuthorizerGoogleSheetsGoogleSheetsAuthorizerOAuthProcessCallbackRequestConfigInner.from_dict(_item) for _item in obj["config"]] if obj.get("config") is not None else None
        })
        return _obj
