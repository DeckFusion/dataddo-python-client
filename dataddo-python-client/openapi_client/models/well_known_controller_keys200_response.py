...
class WellKnownControllerKeys200Response(BaseModel):
    """
    WellKnownControllerKeys200Response
    """ # noqa: E501
    keys: Optional[List[List[JWKSInner]]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in keys (list of list)
        _items = []
        if self.keys:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "keys": [
                    [JWKSInner.from_dict(_inner_item) for _inner_item in _item]
