...
class AwsMssqlDtoAuthorizer(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["useSSH", "certificateId", "sshHost", "sshPort", "sshRemoteHost", "sshRemotePort", "sshUsername", "sshPassword", "label"]
