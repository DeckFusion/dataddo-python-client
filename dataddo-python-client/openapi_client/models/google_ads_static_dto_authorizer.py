...
class GoogleAdsStaticDtoAuthorizer(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["staticKey", "label", "clientId", "clientSecret", "redirectUri", "developerToken", "clientCustomerId"]
